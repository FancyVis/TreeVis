...
Below is an example tree visualization generated by TreeVis from a simple CSV input:

![Example TreeVis output](example_figures/small_example.png)

See [`example_figures/small_example_parameters.txt`](example_figures/small_example_parameters.txt) for the specific plot settings.